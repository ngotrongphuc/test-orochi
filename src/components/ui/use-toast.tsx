...
import { ErrorToast, InformationToast, SuccessToast, WarningToast } from '../toast/CustomToast'
...
function toast({
  ...
  switch (variant) {
    ...
    case 'error':
     ...
     break;
    case 'comingSoon':
     description = InformationToast({ message });
     break;
    default:
     description = WarningToast({ message });
  }
  ...
  const update = (props: ToasterToast) =>
    dispatch({
      type: 'UPDATE_TOAST',
      toast: { ...props, id, position, style, duration, message, variant, description },
    })
